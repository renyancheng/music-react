...
const AudioPlayer = ({
	...
	const { togglePlayPause, play,pause, ready, loading, playing, volume } =
		useAudioPlayer({
			src,
			format: "mp3",
			autoplay: true,
	...
	const onPositionChange = (_, newProgress) => {
    pause();
